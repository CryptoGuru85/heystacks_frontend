<template>
  <div>
    <div v-if="state.layoutData.page === 'list'">
      <div>
        <h3 class="display-1 font-normal text-default mb-3">
          Gatherings
        </h3>
        <h4 class="text-default font-bold">A space for public Google docs about specific topics</h4>
      </div>

      <div class="min-h-700">
        <button
          class="w-3/5 mt-5 mb-8 py-2 text-xl text-white rounded duration-200 bg-orange-600 hover:bg-orange-500 active:bg-orange-400 min-w-200"
